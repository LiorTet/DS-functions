...
def plot_count_distribution(data_series,
                            plot_size=(10, 6),
                            tick_interval=1,
                            label_rotation=45,
  ...
  plt.xticks(ticks=range(0, len(data_series), tick_interval),
              labels=data_series.index[::tick_interval], rotation=label_rotation)
...
def calculate_brand_frequency(df,
                              brand_column='brand',
                              top_n=None):
  """
...
def plot_brand_frequency(brand_frequency_df,
                         brand_column='brand',
                         figsize=(10, 8),
